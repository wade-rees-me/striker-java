	...
	public Shoe(int numberOfDecks, float penetration) {
		...
		for (int i = 0; i < numberOfDecks; i++) {
			for (int j = 0; j < suits.length; j++) {
				cards.add(new Card(suits[j], TWO, "2", 2, 0));
				cards.add(new Card(suits[j], THREE, "3", 3, 1));
				cards.add(new Card(suits[j], FOUR, "4", 4, 2));
				cards.add(new Card(suits[j], FIVE, "5", 5, 3));
				cards.add(new Card(suits[j], SIX, "6", 6, 4));
				cards.add(new Card(suits[j], SEVEN, "7", 7, 5));
				cards.add(new Card(suits[j], EIGHT, "8", 8, 6));
				cards.add(new Card(suits[j], NINE, "9", 9, 7));
				cards.add(new Card(suits[j], TEN, "T", 10, 8));
				cards.add(new Card(suits[j], JACK, "J", 10, 9));
				cards.add(new Card(suits[j], QUEEN, "Q", 10, 10));
				cards.add(new Card(suits[j], KING, "K", 10, 11));
				cards.add(new Card(suits[j], ACE, "A", 11, 12));
			}
		}
